...
```
git clone git@github.com:lmribeiro/kho.git
...
return [
    ...
    'dsn' => 'mysql:host=localhost;dbname=kho',
    'username' => 'root',
    'password' => 'root',
    'charset' => 'utf8',
];
...
```
CREATE DATABASE kho;
GRANT ALL PRIVILEGES ON kho.* TO '<your_user>'@localhost identified by '<your_password>';
quit
```
